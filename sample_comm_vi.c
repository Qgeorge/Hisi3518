...
//zqjun.
HI_S32 SAMPLE_COMM_VI_ChangeFrameRate(VI_CHN ViChn, HI_U32 setFrameRate)
{
    VI_CHN_ATTR_S stChnAttr;
    HI_S32 S32Ret = HI_SUCCESS;
    S32Ret = HI_MPI_VI_GetChnAttr(ViChn, &stChnAttr);
    ...
    stChnAttr.s32SrcFrameRate = setFrameRate + 2;
    stChnAttr.s32FrameRate = setFrameRate; //s32FrameRate should less than s32SrcFrameRate.
    ...
    printf("[%s, %d]...cahnge frame rate done!...\n", __func__, __LINE__);
